...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>BILLINGCHECK/SERVERADM</title>
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  ...
                  <span class="d-none d-md-inline ml-1">BILLINGCHECK / SERVERADM</span>
                </div>
              </a>
          ...
          <div class="nav-wrapper">
            ...
            <!--   <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link " href="noc">
                  <i class="material-icons">vertical_split</i>
                  <span>NOC</span>
                </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link " href="comverse-check">
                    <i class="material-icons">vertical_split</i>
                    <span>COMVERSE CHECK</span>
                  </a>
                </li>
              <!-- <li class="nav-item">
 ...
 -->            </ul>
    ...
    <script src="js/scripts/app/app-blog-overview.1.1.0.js"></script>
  </body>
</html>
