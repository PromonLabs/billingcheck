...
<body>
<h3>DATA UNIX CHECK LOG:UPDATE DATA<h3></h1>
...
<h5 align="center" >
<form action="dataunixlog_update.php" method="post">
&nbsp;
...
$myresult = pg_query($connection,
 "UPDATE serveradm.dataunixlog SET $_POST[kol]=lower({$eq})  WHERE  logid=$_POST[logid]; "); 
