...
<body>
<h3>DATA UNIX CHECK SYSTEM LOG:UPDATE DATA<h3></h1>
...
<h5 align="center" >
<form action="checklog_update.php" method="post">
&nbsp;
...
$myresult = pg_query($connection,
 "UPDATE serveradm.checklog SET $_POST[kol]=lower({$eq})  WHERE  logid=$_POST[logid]; "); 
