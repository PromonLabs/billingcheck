<div class="pull-left"><h4>COMVERSE TEAM : MONITORING POINTS</h4></div>
<div class="pull-right"<h4><?php echo date('l jS \of F Y h:i:s A'); ?></h4></div>
<div style="clear:both;"></div>
<div class="col-md-9">
  <div id="container_div_content"> 
    <table class="table table-striped table-hover">
      ...
      <tr>
      <!--  <td>USAGE GENEREL</td>-->
      <!--  <td><a href="http://billingcheck.srv.gl/billingadm/stat_08.jpeg"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></td>-->
      <!--  <td>EMM</td>-->
      <!--   <td><a href="http://wiki.srv.gl/dokuwiki/doku.php?id=data_unix:billingcheck:gen_usage">info</td> -->
      </tr>
    </table>
  </div>
</div> 
<div class="col-md-3">
  <div class="col-md-12" id="container_div_content" style="margin-bottom:10px;">
    <h4>Link to Billingcheck : </h4>
    <table class="table table-striped table-hover">
    <tr>
      <td>Insert data</td>
  ...
  <div class="col-md-12" id="container_div_content">
    <h4>DOCUMENTS:</h4>
    <table class="table table-striped table-hover">
      <tr>
